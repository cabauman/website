...
      [System.Reactive.Concurrency.HistoricalScheduler](HistoricalScheduler/HistoricalScheduler)
...
NameDescription![Protected method](https://reactiveui.net/assets/img/Hh303103.protmethod(en-us,VS.103).gif "Protected method")[HistoricalSchedulerBase](HistoricalSchedulerBase/HistoricalSchedulerBase)Creates a new historical scheduler, using the minimum value of DateTimeOffset as the initial clock value.Top
